...
var questions = [
    {
        "Cricket matches are organised:": [
            ...
            "Game represents the unity of country",
    ...
    {
        "Change in cricket game rules in the 1760s led to immediate change in:": [
    ...
    {
        "Post industrial influence in cricket is visible as:": [
            "pads",
            "bat",
            "ball",
            "stumps"
    ...
    {
        "Who was the first professional to lead the English team?": [
            "Len Hutton",
            "Thomas Hughes",
            "Vijay Hazare",
            "Garry Sobers"
    ...
    {
        "Which Indian community was the first to set up a cricket club?": [
            "Parsis",
            "Hindus",
            "Muslims",
            "Christians"
    ...
    {
        "Cricket in colonial India was organised on the principle of:": [
            "race and religion",
            "region",
            "religion",
            "national loyalties"
    ...
    {
        "Who among the following was not critical of the Pentangular Tournament?": [
            "Dada Bhai Naoroji",
            "M.K. Gandhi",
            "AFS Talyarkhan",
            "S.A. Brelvi"
...
exports.handler = function (event, context) {
    try {
        if (event.session.application.applicationId !== "amzn1.echo-sdk-ams.app.94b7f79f-8776-4329-88a1-9ad871ae3f1a") {
...
var ANSWER_COUNT = 4;
var GAME_LENGTH = 5;
var CARD_TITLE = "Classical Cricket Game"; // Be sure to change this for your skill.

function getWelcomeResponse(callback) {
    var sessionAttributes = {},
        speechOutput = "Classical Cricket Game. I will ask you " + GAME_LENGTH.toString()
